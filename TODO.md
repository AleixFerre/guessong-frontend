- CONTENT
  - Add the videogame OST category with songs like
    ...
    - To Zanarkand
    - littleroot town
    - evolution pokemon song
  - Add a Bill Wurtz category
  - Add a series intros category

---

- Dark mode
- Functionality of custom playlists from youtube

---

DOPAMINA MODE

- Sound effects on click, on win or loose, on fail song
